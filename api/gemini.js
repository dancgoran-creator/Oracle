...
module.exports = async function handler(req, res) {
  ...
  if (mode === 'analyst' && ticker) {
    const p = `Analyst consensus for ${ticker}. Respond with ONLY this JSON (no markdown, no backticks):
{"ticker":"${ticker}","buy":"18","hold":"5","sell":"2","pt_low":"150.00","pt_median":"210.00","pt_high":"280.00","upside_pct":"15.4"}
Replace the numbers with real values for ${ticker}. Use N/A if unknown.`;
